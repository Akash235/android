...
public class Item {
    ...
    public static ArrayList<Item> getTestingList() {
        ...
        items.add(new Item("Akash", "", "katraj", "office", 3, "joindate", "05:10 PM"));
        items.add(new Item("Shubham", "", "Satchayimata mandir", "office", 10, "joindate", "11:10 AM"));
        items.add(new Item("Aadarsh", "", "Yevalewadi", "office", 0, "joindate", "07:11 PM"));
        items.add(new Item("Rushikesh", "", "Near sagarsweet", "office", 8, "joindate", "4:15 AM"));
